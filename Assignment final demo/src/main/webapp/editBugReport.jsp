...
<form action="editBug" method="post">
    ...
    <table>
        <tr>
            ...
            <td><input type="text" id="summary" name="summary" value="<c:out value='${bug.summary}' />"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="costToFix" name="costToFix"
                       value="<fmt:formatNumber value='${bug.costToFix}'
